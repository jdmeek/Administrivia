...
profile will overload any public(context) options set by the libraries.
...
Write-Host "PowerShell ISE SOC Environment $Version ( PSVer:"$PsVersionTable.PSVersion")`n"
